...
public class NameFileComparator implements Comparator, Serializable {
	 ...
	 */
	public static final Comparator NAME_REVERSE = new ReverseComparator(
			NAME_COMPARATOR);
	 ...
	 * )
	 */
	public static final Comparator NAME_INSENSITIVE_COMPARATOR = new NameFileComparator(
			IOCase.INSENSITIVE);
	 ...
	 */
	public static final Comparator NAME_INSENSITIVE_REVERSE = new ReverseComparator(
			NAME_INSENSITIVE_COMPARATOR);

	/** System sensitive name comparator instance (see {@link IOCase#SYSTEM}) */
	public static final Comparator NAME_SYSTEM_COMPARATOR = new NameFileComparator(
			IOCase.SYSTEM);
	 ...
	 * {@link IOCase#SYSTEM})
	 */
	public static final Comparator NAME_SYSTEM_REVERSE = new ReverseComparator(
