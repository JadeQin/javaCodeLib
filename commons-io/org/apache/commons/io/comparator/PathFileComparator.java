...
public class PathFileComparator implements Comparator, Serializable {
	 ...
	 */
	public static final Comparator PATH_REVERSE = new ReverseComparator(
			PATH_COMPARATOR);
	 ...
	 * )
	 */
	public static final Comparator PATH_INSENSITIVE_COMPARATOR = new PathFileComparator(
			IOCase.INSENSITIVE);
	 ...
	 */
	public static final Comparator PATH_INSENSITIVE_REVERSE = new ReverseComparator(
			PATH_INSENSITIVE_COMPARATOR);

	/** System sensitive path comparator instance (see {@link IOCase#SYSTEM}) */
	public static final Comparator PATH_SYSTEM_COMPARATOR = new PathFileComparator(
			IOCase.SYSTEM);
	 ...
	 * {@link IOCase#SYSTEM})
	 */
	public static final Comparator PATH_SYSTEM_REVERSE = new ReverseComparator(
