...
public abstract class Evaluator {
	...
	static final class AttributeWithValueStarting extends AttributeKeyPair {
		...
		public boolean matches(Element element) {
			return element.attr(key).toLowerCase().startsWith(value); // value
																		// is
																		// lower
																		// case
																		// already
	...
	static final class AttributeWithValueEnding extends AttributeKeyPair {
		...
		public boolean matches(Element element) {
			return element.attr(key).toLowerCase().endsWith(value); // value is
																	// lower
																	// case
		}
	}
	...
	static final class AttributeWithValueContaining extends AttributeKeyPair {
		...
		public boolean matches(Element element) {
			return element.attr(key).toLowerCase().contains(value); // value is
																	// lower
																	// case
		}
	}
