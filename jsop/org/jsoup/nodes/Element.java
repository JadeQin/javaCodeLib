...
public class Element extends Node {
	...
	/**
	 * Find elements that match the selector query, with this element as the
	 * starting context. Matched elements may include this element, or any of
	 * its children.
	 * <p/>
	...
	public Element append(String html) {
		...
		Element fragment = Parser.parseBodyFragmentRelaxed(html, baseUri())
				.body();
	 ...
	 *            {@code <div class="head"></div>}. Can be arbitralily deep.
	 * @return this element, for chaining.
	 */
	public Element wrap(String html) {
		Validate.notEmpty(html);

		Element wrapBody = Parser.parseBodyFragmentRelaxed(html, baseUri)
				.body();
		...
		// remainder (unbalananced wrap, like <div></div><p></p> -- The <p> is
		// remainder
	...
	void outerHtml(StringBuilder accum) {
		if (isBlock()
				|| (parent() != null && parent().tag().canContainBlock() && siblingIndex() == 0))
			indent(accum);
