 ...
 * carrots, they jump as quickly as possible. Initially, rabbit Hanako stands at
 * position init. From position x, she can jump to either position 4*x+3 or
 * 8*x+7 in a single jump. She can jump at most 100,000 times because she gets
 * tired by jumping. Carrots are planted at position x if and only if x is
 * divisible by 1,000,000,007 (i.e. carrots are planted at position 0, position
